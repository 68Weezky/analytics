...
<script>
    ...
    // Define users data
    let users = [
        { id: 1, name: 'John Doe', email: 'john@example.com', rank: 'admin', team: 'Team A' },
        { id: 2, name: 'Jane Smith', email: 'jane@example.com', rank: 'team_manager', team: 'Team B' },
        { id: 3, name: 'Bob Wilson', email: 'bob@example.com', rank: 'user', team: 'Team C' },
        { id: 4, name: 'Alice Brown', email: 'alice@example.com', rank: 'league_manager', team: null },
        { id: 5, name: 'Charlie Davis', email: 'charlie@example.com', rank: 'user', team: 'Team A' },
    ];

    const updateRank = (userId, newRank) => {
        console.log(`Updating user ${userId} to rank ${newRank}`);
...
<svelte:head>
    <title>Hockey K.E - User Management</title>
        ...
        <nav class="p-4">
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 11a1 1 0 01-2 0V9a1 1 0 012 0v4zm-1-6a1.5 1.5 0 110-3A1.5 1.5 0 0110 7z" />
                        </svg>
                        user management
                    </Button>
                </li>
        ...
        <header class="bg-primary text-white py-4 sticky top-0 z-40">
            <div class="container mx-auto px-4 md:px-8 flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="text-xl font-bold tracking-wide">User management</div>
                </div>
                <button
                    type="button"
                    on:click={toggleMenu}
        ...
        <main class="container mx-auto px-4 md:px-8 my-8">
            <Card.Root>
                <Card.Content>
                            ...
                            <tbody>
                                {#each users as user}
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="p-4">
                                            <select class="p-2 border rounded" on:change={(e) => updateRank(user.id, e.target.value)} value={user.rank}>
                                        ...
                                        <td class="p-4">{user.team || 'N/A'}</td>
                                        <td class="p-4">
                                            <Button variant="destructive" size="sm" class="" on:click={() => deleteUser(user.id)}>
                                                Delete
                                            </Button>
                                        </td>
                                    </tr>
                    ...
                    <div class="mt-4">
                        <Button variant="default" on:click={() => window.location.href = '/add-user'}>
                            Add User
                        </Button>
                    </div>
                </Card.Content>                
